        ...
        case '% ОФ':
            modalText =  <>
                ...
                <div className='modalBody2'>
                    ...
                    <p><Chip label="Зеленый: разрыв 14% и менее" sx={{backgroundColor: '#2db432', color: 'white'}} /></p>
                </div>
            </>
            break;
        case '% ОиМ':
        ...
        case '% НЗП':
            modalText =  <>
                ...
                <div className='modalBody2'>
                    ...
                    <p><b>УСЛОВИЯ ОКРАШИВАНИЯ:</b></p>
                    <p>В сравнении с показателем % ОС.</p>
                    <p><Chip label="Красный: разрыв 59% и менее" sx={{backgroundColor: '#f60209', color: 'white'}} /></p>
                    <p><Chip label="Желтый: разрыв от 60% до 89%" sx={{backgroundColor: '#f9de05', color: 'white'}} /></p>
                    <p><Chip label="Зеленый: разрыв 90% и более" sx={{backgroundColor: '#2db432', color: 'white'}} /></p>
                </div>
            </>
            break;
        case '% ПРОЦ':
            modalText =  <>
                ...
                <div className='modalBody2'>
                    ...
                    <p><b>УСЛОВИЯ ОКРАШИВАНИЯ:</b></p>
                    <p>В сравнении с показателем % ОС.</p>
                    <p><Chip label="Красный: разрыв 26% и более" sx={{backgroundColor: '#f60209', color: 'white'}} /></p>
                    <p><Chip label="Желтый: разрыв от 16% до 25%" sx={{backgroundColor: '#f9de05', color: 'white'}} /></p>
                    <p><Chip label="Зеленый: разрыв 15% и менее" sx={{backgroundColor: '#2db432', color: 'white'}} /></p>
                </div>
            </>
            break;
        case '% ПРИН':
            modalText =  <>
                ...
                <div className='modalBody2'>
                    ...
                    <p><Chip label="Желтый: %ПРИН > %ПРОЦ" sx={{backgroundColor: '#f9de05', color: 'white'}} /></p>
                    <p><Chip label="Зеленый: %ПРИН = %ПРОЦ" sx={{backgroundColor: '#2db432', color: 'white'}} /></p>
                </div>
            </>
            break;
        default:
