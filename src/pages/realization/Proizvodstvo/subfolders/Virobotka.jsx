        ...
        <div>
            <TableHead extra={'tableFormat'}>
                ...
                <div style={{flexBasis: '10%'}}>
                    <Tooltip title={'СРЕДНЯЯ ЗП "НА РУКИ" НА 1 РАБОЧЕГО ЗА ОТЧЕТНЫЙ / ПРЕДЫДУЩИЙ ПЕРИОД'}>
                    <span>СРЕДНЯЯ ЗП "НА РУКИ" НА 1 РАБОЧЕГО ЗА ОТЧЕТНЫЙ / ПРЕДЫДУЩИЙ ПЕРИОД</span>
                    </Tooltip>
                </div>
